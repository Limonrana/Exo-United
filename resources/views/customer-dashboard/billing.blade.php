...
@section('title', 'Exo-United | Billing Details')
                ...
                <div class="col-lg-9 order-lg-last dashboard-content">
                    ...
                    <div class="card">
                        <div class="card-header">
                            Address Book
                            <a href="{{ route('customer.profile') }}" class="card-edit text-dark"><u>Edit</u></a>
                        </div><!-- End .card-header -->

                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <h4 class="text-dark pb-2">Default Billing Address</h4>
                                    <address>
                                        {{ Auth::user()->name }}<br>
                                        {{ Auth::user()->email }}<br>
                                        {{ Auth::user()->phone }}<br>
                                        ...
                                        <a href="{{ route('customer.profile') }}" class="text-dark"><u>Edit Address</u></a>
                                    </address>
                                </div>
                            </div>
                        </div><!-- End .card-body -->
