...
@section('title', 'Exo-United | Experience')
                    ...
                    <div class="inner-page-banner-area">
                        ...
                        <nav aria-label="breadcrumb" class="page-header-breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('shop.page') }}">experience</a></li>
                        ...
                        <div class="latest-result-item">
                            <div class="post-item my-product">
                                ...
                                <div class="content">
                                    ...
                                    <a href="{{ route('single.experience.view', [$val->slug, Str::random(20)]) }}" class="blog-btn">view more</a>
                                </div>
                            </div>
                            @php
