@extends('layouts.app')
@section('title', 'Exo-United | Change Customer Password')
@section('content')
    <main class="main">
                ...
                <div class="col-lg-9 order-lg-last dashboard-content pt-2 pb-5">
                    @if ($user->provider)
                        <div class="alert alert-danger mt-5" role="alert">
                            Hello, <strong>{{ Auth::user()->name }}! </strong> We are sorry to say that, You can't change your password from here. Because you are sign up from your {{ $user->provider }} Account.
                        </div><!-- End .alert -->
                    @else
