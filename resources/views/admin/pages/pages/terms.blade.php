...
@section('title', 'Terms & Conditions - Exo-United')
...
@section('content')
    ...
    <div class="sl-mainpanel">
        <nav class="breadcrumb sl-breadcrumb">
            ...
            <a class="breadcrumb-item" href="">Terms & Conditions</a>
            <span class="breadcrumb-item active">Panel</span>
        </nav>

        <div class="sl-pagebody">
            <div class="sl-page-title">
                <h5>Terms & Conditions Panel</h5>
            </div><!-- sl-page-title -->

            <div class="card pd-20 pd-sm-40">
                <h6 class="card-body-title pb-2">Content Panel</h6>
                <form action="{{ route('admin.page.roles.update', $get->id) }}" method="post">
                    @csrf
