...
@section('title', 'SEO Information | Exo-United')
@section('content')
    <!-- ########## START: MAIN PANEL ########## -->
                ...
                <div class="col-xl-9 m-auto">
                    <div class="card pd-20 pd-sm-40 form-layout form-layout-4">
                        ...
                        <form class="mt-4" action="{{ route('admin.tools.seo.update', $seo->id) }}" method="post">
                            ...
                            <div class="form-group">
                                <label for="bing_analytics">Facebook Pixel</label>
                                <textarea class="form-control" id="fb_pixel" name="fb_pixel" rows="4">{{ $seo->fb_pixel }}</textarea>
                            </div>
