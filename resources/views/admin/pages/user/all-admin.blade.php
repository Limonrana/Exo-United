...
@section('title', 'All Admin | Exo-United')
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @if ($val->roles->pages == 1)
                                    ...
                                    @else
                                @endif
                                    @if ($val->roles->winners == 1)
                                        <span class="badge badge-success">Winners</span>
                                    @else
                                    @endif
