...
@section('title', 'Add New Admin | Exo-United')
@section('content')
<!-- ########## START: MAIN PANEL ########## -->
                    ...
                    <form class="mt-4" action="{{ route('admin.user.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-lg-4 mg-t-20 mg-lg-t-0">
                                    <label class="ckbox">
                                        <input type="checkbox" name="winners" value="1"><span>Winners</span>
                                    </label>
                                </div><!-- col-3 -->
                            </div><!-- row -->
                            <div class="row mg-t-10">
                                ...
                                <div class="col-lg-4 mg-t-20 mg-lg-t-0">
                                    <label class="ckbox">
                                        <input type="checkbox" name="experience" value="1"><span>Experience</span>
                                    </label>
                                </div><!-- col-3 -->
                            </div><!-- row -->
                            <div class="row mg-t-10">
                                ...
                                <div class="col-lg-4 mg-t-20 mg-lg-t-0">
                                    <label class="ckbox">
                                        <input type="checkbox" name="entry" value="1"><span>Entry Level</span>
                                    </label>
                                </div><!-- col-3 -->
                                <div class="col-lg-4 mg-t-20 mg-lg-t-0">
                                    <label class="ckbox">
                                        <input type="checkbox" name="drawn" value="1"><span>Drawn</span>
                                    </label>
                                </div><!-- col-3 -->
                            </div><!-- row -->
                            <div class="row mg-t-10">
            ...
            <div class="col-xl-3 mg-t-25 mg-xl-t-0">
                <div class="card pd-20 pd-sm-40 form-layout form-layout-5">
                    ...
                    <div class="preview_image mt-3 text-center">
                        <img id="avatar_show" width="300px">
                    </div>
