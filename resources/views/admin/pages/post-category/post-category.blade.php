...
@section('title', 'All Post Categories | Exo-United')
                        ...
                        <div class="modal-body pd-20">
                            <p class="mg-b-5">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('category_name_en') is-invalid @enderror" id="category_name_en" name="category_name_en" placeholder="Enter Category Name">
