...
@section('title', 'All Post Tags | Exo-United')

@section('content')
    <!-- ########## START: MAIN PANEL ########## -->
    <div class="sl-mainpanel">
        <nav class="breadcrumb sl-breadcrumb">
            <a class="breadcrumb-item" href="{{ route('admin.brand') }}">Exo-United</a>
                        ...
                        <div class="modal-body pd-20">
                            <p class="mg-b-5">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('tag_name_en') is-invalid @enderror" id="tag_name_en" name="tag_name_en" placeholder="Enter Tag Name">
                                    @error('tag_name_en')
