                    ...
                    <table id="datatable1" class="table display responsive nowrap">
                        ...
                        @forelse($entry as $key => $val)
                            <tr>
                                ...
                                <td><img src="{{ asset($val->entry->entry_image ? $val->entry->entry_image : 'uploads/no-image/no-image.png') }}"
                                         width="80px" height="50px"></td>
                                <td>{{ $val->entry->entry_title }}</td>
                                <td>{{ $val->entry->entry_quantity }} Entries</td>
                        ...
                        @empty
                            <td colspan="20" style="padding-top: 5%; padding-bottom: 5%;">
                                <h3 class="text-dark text-center">NO ENTRY HERE</h3>
                            </td>
                        @endforelse
                        </tbody>
                    </table>
