...
@section('title', 'Winner View | Exo-United')
@section('content')
    <!-- ########## START: MAIN PANEL ########## -->
    <div class="sl-mainpanel">
        <nav class="breadcrumb sl-breadcrumb">
            <a class="breadcrumb-item" href="{{route('admin.dashboard')}}">Exo-United</a>
            <span class="breadcrumb-item active">Winner View</span>
        </nav>
        <div class="sl-pagebody">

            <div class="row-sm mg-t-20 pl-2 pr-2">
                <div class="card pd-20 pd-sm-40" id="mydiv">
                    <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10 text-center">Winner Processing.......</h6>
                ...
                <div class="card pd-20 pd-sm-40" id="mydiv2">
                    <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10">Winner View</h6>
                    <div class="col-md-12 mg-t-30">
                        <div class="table-wrapper">
                            <table id="datatable1" class="table display responsive nowrap">
                                <thead>
                                @if ($winner->free_user_id == null)
                                    <tr>
                                        <th class="wd-40p">Winner Name : </th>
                                        <th class="wd-60p">{{ $winner->user->name }}</th>
                                    </tr>
                                    <tr>
                                        <th class="wd-40p">Winner Email : </th>
                                        <th class="wd-60p">{{ $winner->user->email }}</th>
                                    </tr>
                                    <tr>
                                        <th class="wd-40p">Winner Phone : </th>
                                        <th class="wd-60p">{{ $winner->user->phone }}</th>
                                    </tr>
                                    <tr>
                                        <th class="wd-40p">Winner Address :</th>
                                        <th class="wd-60p">{{ $winner->user->city.", ".$winner->user->state.", ".$winner->user->country }}</th>
                                    </tr>
                                @else
                                    <tr>
                                        <th class="wd-40p">Winner Name : </th>
...
@section('admin-js')
    <script>
        ...
        setTimeout(function(){ $("#mydiv2").show(); }, 10000);
    </script>
@endsection
